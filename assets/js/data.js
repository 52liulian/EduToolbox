...
[
    ...
    },
    {
      ...
      subCategories: [
        {
          ...
          tools: [
            ...
            {name:"成语大全", desc:"成语查询、典故解释、成语接龙", tags:["语文", "成语"], url:"https://www.hanyuguoxue.com/chengyu/"},
          ]
        },
        {
          id: "math", name: "数学", icon: "🔢", desc: "几何、公式、计算",
          tools: [
        ...
        {
          id: "english", name: "英语", icon: "🔠", desc: "词汇、阅读、语法",
          tools: [
      ...
      tools: [
        ...
        {name:"七彩课堂", desc:"七彩课堂配套教学资源，直接下载，无需登录注册", tags:["教学资源", "下载"], url:"https://www.timebook.cc/column85"},
        {name:"状元大课堂", desc:"状元大课堂免费课件", tags:["教学资源", "PPT", "免费"], url:"https://www.wookey.cn/kjfl"},
        {name:"荣德基", desc:"点拔、典中典官方免费提供的课件", tags:["教学资源", "PPT", "免费"], url:"https://www.rudder.com.cn/0/booklist.html"},
        ...
        {name:"卡兜课堂游戏", desc:"卡兜提供大量互动游戏模版，可以快速制作课堂游戏。例如：女巫的毒药、狼人杀、对对碰等", tags:["课堂互动", "教学资源"], url:"https://kadou.cn/"},
    ...
    },
    {
      ...
      tools: [
        ...
        {name:"icc", desc:"实用的屏幕批注软件，便捷在屏幕上书写", tags:["教学管理", "批注"], url:"https://github.com/InkCanvas/InkCanvasForClass"}, 
      ]
    },
    {
    ...
    },
    {
      ...
      tools: [
        {name:"浙江图书馆", desc:"可以借用浙江图书馆免费下载知网的文献", tags:["学术科研", "免费", "下载"], url:"https://www.zjlib.cn/"},
...
//    
      ...
      subCategories: [
        {
         id: "audio", name: "音频处理", icon: "🎵", desc: "文字转语音、音频剪辑、人声分离与音效下载",
          tools: [
            ...
            {name:"妙响", desc:"汽水音乐推出的Ai自动创作音乐的平台，不懂音乐的人也能拥有自己的音乐了", tags:["音频处理", "AI", "音频"], url:"https://music.douyin.com/studio"},
            {name:"海绵音乐", desc:"字节跳动推出的免费AI音乐创作和发现平台",tags:["音频处理", "AI", "音频"], url:"https://www.haimian.com/"},
            {name:"Mureka", desc:"昆仑万维推出的AI音乐创作平台，一键生成原创歌曲", tags:["音频处理", "AI", "音频"], url:"https://www.mureka.cn/"},
            {name:"TME Studio", desc:"腾讯音乐推出的智能音乐创作助手", tags:["音频处理", "AI", "音频"], url:"https://y.qq.com/tme_studio/"},
            {name:"Udio", desc:"免费的AI音乐创作工具，每月可生成1200首歌曲", tags:["音频处理", "AI", "音频"], url:"https://www.udio.com/"},
            {name:"网易云音乐·X Studio", desc:"网易云音乐与小冰智能联合推出的免费AI歌手音乐创作软件", tags:["音频处理", "AI", "音频"], url:"https://xstudio.music.163.com/"},
            {name:"ACE Studio", desc:"AI歌声合成工具，输入歌词与旋律即可生成宛如真人的歌声", tags:["音频处理", "AI", "音频"], url:"https://acestudio.cn/"},
            {name:"BGM猫", desc:"灵动音科技推出的AI智能生成BGM音乐", tags:["音频处理", "AI", "音频"], url:"https://bgmcat.com/"},
        ...
        },
        {
         id: "image", name: "图像处理", icon: "🖼️", desc: "抠图压缩、在线 PS、AI 放大与设计工具",
          tools: [
            ...
            {name:"在线PS", desc:"PS软件网页版 ，小白用户易上手！", tags:["图像处理", "图片", "在线"], url:"https://www.gaoding.com/editor/ps"},
      ...
      subCategories: [
        {
         id: "DeepSeek", name: "DeepSeek", icon: "🤖", desc: "DeepSeek",
          tools: [
            {name:"问小白(满血版DeepSeek)", desc:"满血版DeepSeek，还能一键生成图片、PPT", tags:["AI"], url:"https://www.wenxiaobai.com/"},
            {name:"灵犀", desc:"WPS部署的DeepSeek", tags:["AI"], url:"https://lingxi.kdocs.cn/"},
            {name:"硅基流动", desc:"硅基流动部署的DeepSeek，可以直接用，也有API", tags:["AI"], url:"https://siliconflow.cn/"},
            {name:"火山方舟", desc:"字节跳动部署的DeepSeek，可以直接用，也有API", tags:["AI"], url:"https://www.volcengine.com/experience/ark"},
          ]
        },
        {
         id: "AI对话", name: "AI对话", icon: "💬", desc: "AI对话助手工具",
          tools: [
            {name:"TRAE-AI编程", desc:"字节旗下AI代码助手", tags:["AI"], url:"https://www.trae.cn/"},
            {name:"Kimi", desc:"可以投喂网址和文档的AI", tags:["AI"], url:"https://www.kimi.com/"},
            {name:"钉钉·个人版", desc:"钉钉推出的个人版，里面有AI功能", tags:["AI"], url:"https://workspace.dingtalk.com/welcome"},
            {name:"腾讯混元", desc:"腾讯推出的AI大模型", tags:["AI"], url:"https://hunyuan.tencent.com/"},
            {name:"OpenRouter", desc:"一个描述，百个模型同时回答你", tags:["AI"], url:"https://openrouter.ai/"},
            {name:"DeepSeek", desc:"杀出来的一匹黑马，所说直逼GPT4", tags:["AI"], url:"https://chat.deepseek.com/sign_in"},
            {name:"智谱清言(沉思)", desc:"国产著名的大模型，能生成详细的调研报告", tags:["AI"], url:"https://chatglm.cn/apps"},
            {name:"Qwen", desc:"阿里千问通义在线对话版", tags:["AI"], url:"https://chat.qwen.ai/"},
            {name:"墨刀AI", desc:"墨刀家的AI智能体", tags:["AI"], url:"https://modao.cc/feature/ai"},
            {name:"智谱国际版", desc:"智谱国际版，无广告之类", tags:["AI"], url:"https://chat.z.ai/"},
          ]
        },
        {
          id: "AI画图", name: "AI画图", icon: "🖌️", desc: "AI绘图工具",
          tools: [       
            {name:"Upscayl", desc:"利用AI将图片无损放大", tags:["AI"], url:"https://upscayl.org/"},
            {name:"Remove.bg", desc:"利用AI去除图片的背景", tags:["AI"], url:"https://www.remove.bg/zh"},
            {name:"免抠图片网", desc:"可以免费进行AI绘图的网站", tags:["AI"], url:"https://miankoutupian.com/"},
            {name:"吐司TusiArt", desc:"强大的AI绘图网站，可以自定义模型，每天免费100张", tags:["AI"], url:"https://tusi.cn/"},
            {name:"即梦", desc:"字节旗下的AI绘图、视频生成，非常漂亮~", tags:["AI"], url:"https://jimeng.jianying.com/s/ijpH1Qsx/"},
            {name:"Boom-AI", desc:"一款AI驱动的免费Ai绘画，创意商业设计工作流工具", tags:["AI"], url:"https://boom-ai.cn/home"},
            {name:"稿AI工具", desc:"AI图片处理、AI绘图等一站式AI图像创作和设计平台", tags:["AI"], url:"https://www.gaoding.com/"},
            {name:"AI证件照", desc:"在线照相馆，一键换底色、AI最美证件照", tags:["AI"], url:"https://www.gaoding.com/koutu"},
            {name:"稿AI抠图", desc:"AI智能抠图、证件照换底色、批量抠图", tags:["AI"], url:"https://www.gaoding.com/koutu"},
            {name:"墨刀设计", desc:"轻松制作出漂亮的UI设计", tags:["AI"], url:"https://modao.cc/feature/design/"},
            {name:"墨刀原型", desc:"简单拖拽搭建原型，交互、真机效果", tags:["AI"], url:"https://modao.cc/feature/prototype/"},
            {name:"Flowith", desc:"免费使用香蕉2、Gemini3", tags:["AI"], url:"https://flowith.net"},
          ]
        },
        {
          id: "AI工具", name: "AI工具", icon: "🧰", desc: "其它AI工具",
          tools: [       
            {name:"Show Code", desc:"把AI生成的Html、mermaid托管在网站上", tags:["AI"], url:"https://www.showyourcode.app/zh"},
            {name:"Echarts", desc:"可以借助AI生成漂亮的图表", tags:["AI"], url:"https://echarts.apache.org/examples/zh/editor.html"},
            {name:"MD2Card", desc:"免费一键把MarkDown转为漂亮的卡片", tags:["AI"], url:"https://md2card.com/zh/editor"},
            {name:"降AI率", desc:"论文、科研作品降AI率的神器", tags:["AI"], url:"https://ibiling.cn/paper-pass"},
            {name:"免费托管网页", desc:"国外免费托管网页的平台，AI写的网页可以放这儿", tags:["AI"], url:"https://dash.infinityfree.com/login"},
            {name:"AI好记", desc:"自动将N多视频转换为文本，提取内容", tags:["AI"], url:"https://aihaoji.com/"},
            {name:"HTML2WEB", desc:"把HTML源码转换成网址，可以给别人访问", tags:["AI"], url:"https://html2web.com/"},
            {name:"秒哒", desc:"百度家的，一键生成全栈的网页、小程序", tags:["AI"], url:"https://www.miaoda.cn/"},
          ]
        },
      ],
      tools: [],
  ...
  // 自研免费工具（本地运行，无后端）
  selfTools: [
    {id:"kechengbiao", slug:"kechengbiao", name:"课程表", icon:"📅", desc:"生成和管理课程表",tags:["课程表","课表生成","打印"], mount:"adapter", features:["课程表","生成课程表","管理课程表"]},
    {id:"random-call", slug:"random-call", name:"随机叫号", icon:"📢", desc:"滚动动画随机叫号，适合课堂随机提问",tags:["随机叫号","滚动动画","大屏"], mount:"adapter", features:["🎲 滚动动画","🔢 范围设置","📋 已叫记录","🖥️ 大屏"]},
    {id:"random-lottery", slug:"random-lottery", name:"随机抽签系统", icon:"🎰", desc:"转盘式随机抽签系统，适合各类抽奖与随机选择场景",tags:["随机抽签","转盘抽奖","全屏"], mount:"adapter", features:["🎡 转盘动画","✏️ 自定义选项","🏆 随机结果","🖥️ 全屏"]},
    {id:"rolldraw", slug:"random-draw", name:"随机抽签器", icon:"🎲", desc:"名单导入、随机抽签、语音朗读，课堂提问神器", tags:["随机抽签","名单导入","语音朗读"], mount:"adapter", features:["📋 名单导入","🎲 随机抽签","🔊 语音朗读","⌨️ 快捷键","🔒 本地运行"]},
    {id:"seat", slug:"seat-generator", name:"座位表生成器", icon:"🪑", desc:"设置行列、随机排座、拖拽交换位置", tags:["座位表","随机排座","拖拽调整"], mount:"adapter", features:["🎲 随机排座","🖱️ 拖拽调整","🔢 灵活行列","🔒 本地运行"]},
    {id:"text-diff", slug:"text-diff", name:"文本差异对比", icon:"🔍", desc:"快速比对两段文本的差异，高亮显示新增、删除和修改内容",tags:["文本对比","差异高亮"], mount:"adapter", features:["🔍 文本对比","🟢 新增/删除高亮","📄 按行/词/字"]},
    {id:"word-counter", slug:"word-counter", name:"在线字数统计", icon:"📝", desc:"实时统计中文字数、英文字符、段落数，支持排除标点与空格",tags:["字数统计","段落统计"], mount:"adapter", features:["🔢 中文字数","🔤 英文字符","📊 段落统计","🚫 排除标点"]},
    {id:"qr-generator", slug:"qr-generator", name:"二维码生成器", icon:"📱", desc:"支持文本、链接转换，可自定义颜色和 Logo，高清下载",tags:["二维码","自定义颜色","PNG下载"], mount:"adapter", features:["🎨 自定义颜色","🖼️ 支持 Logo","📏 多尺寸","⬇️ PNG 下载"]},
    {id:"group-maker", slug:"random-group", name:"随机分组工具", icon:"👥", desc:"一键快速分组，支持按组数或人数分配，适合小组讨论",tags:["随机分组","小组讨论"], mount:"adapter", features:["🎲 随机分组","👫 按组/按人数","⚖️ 性别平衡","📋 复制结果"]},
    {id:"timer", slug:"timer", name:"课堂倒计时", icon:"⏱️", desc:"专为课堂设计的倒计时工具，全屏显示、多种提示音效",tags:["倒计时","全屏","提示音"], mount:"adapter", features:["⏱️ 自定义时长","📊 进度圆环","🔔 结束提示","🖥️ 全屏模式"]},
    {id:"pinyin-annotator", slug:"pinyin-annotator", name:"拼音标注", icon:"🔤", desc:"自动为汉字标注拼音，支持声调符号/数字/无声调多种样式",tags:["拼音标注","声调注音"], mount:"adapter", features:["🔤 自动注音","🎵 多种声调","📐 上方/侧注","📋 复制 HTML"]},
    {id:"scrolling-text", slug:"scrolling-text", name:"早读滚动", icon:"📖", desc:"文本从下往上滚动展示，适合课堂投影和学生跟读",tags:["滚动文字","跟读","全屏"], mount:"adapter", features:["📜 滚动文字","🎨 字号/颜色","⚡ 调速","🖥️ 全屏"]},
    {id:"paragraph-scroll", slug:"paragraph-scroll", name:"段落滚动", icon:"📜", desc:"逐段切换展示，类似歌词提词，适合朗读和演讲",tags:["提词器","逐段切换","全屏"], mount:"adapter", features:["📝 逐段切换","⏱️ 停留时长","🎨 字号/颜色","🖥️ 全屏"]},
    {id:"temp-board", slug:"temp-board", name:"课堂记录板", icon:"📋", desc:"快速记录课堂要点、作业安排，支持清空与全屏",tags:["课堂记录","本地保存","全屏"], mount:"adapter", features:["✏️ 快速记录","💾 本地保存","🗑️ 一键清空","🖥️ 全屏展示"]},
    {id:"random-shuffle", slug:"random-shuffle", name:"随机打乱", icon:"🔀", desc:"一键随机打乱名单顺序，适用于点名、轮流发言",tags:["随机洗牌","名单打乱"], mount:"adapter", features:["🎲 随机洗牌","🔢 带序号","📋 复制结果"]},
    {id:"stopwatch", slug:"stopwatch", name:"秒表", icon:"⏱️", desc:"课堂活动计时秒表，支持计次与重置",tags:["秒表","计次计时"], mount:"adapter", features:["⏱️ 毫秒精度","📊 计次记录","⏸️ 暂停/继续","♻️ 重置"]},
    {id:"alarm-clock", slug:"alarm-clock", name:"课堂闹钟", icon:"⏰", desc:"设置多个提醒时间，到点自动响铃提醒",tags:["闹钟","定时提醒"], mount:"adapter", features:["🔔 多闹钟","🔊 响铃提醒","📝 自定义文字","💾 本地保存"]},
    {id:"multi-timer", slug:"multi-timer", name:"多定时器", icon:"⏲️", desc:"同时管理多个倒计时，为不同教学环节分别计时",tags:["多定时器","倒计时","到点提醒"], mount:"adapter", features:["⏲️ 多倒计时","🔔 到点提醒","➕ 加减时长","🗑️ 删除"]},
    {id:"pomodoro", slug:"pomodoro", name:"番茄钟", icon:"🍅", desc:"专注与休息交替，提升课堂专注力",tags:["番茄钟","专注计时"], mount:"adapter", features:["🍅 专注25分","☕ 短休5分","😴 长休15分","📊 完成统计"]},
    {id:"gaokao-countdown", slug:"gaokao-countdown", name:"高考倒计时", icon:"🎓", desc:"距离高考实时倒计时，适合教室投影展示",tags:["高考倒计时","全屏投影"], mount:"adapter", features:["📅 自动计算","⏰ 实时更新","🖥️ 全屏投影","🔢 天/时/分/秒"]},
    {id:"zhongkao-countdown", slug:"zhongkao-countdown", name:"中考倒计时", icon:"📚", desc:"距离中考实时倒计时，适合教室投影展示",tags:["中考倒计时","全屏投影"], mount:"adapter", features:["📅 自动计算","⏰ 实时更新","🖥️ 全屏投影","🔢 天/时/分/秒"]},
    {id:"week-calendar", slug:"week-calendar", name:"学期日历", icon:"📅", desc:"设置开学日期，自动计算教学周次，高亮本周",tags:["学期日历","教学周"], mount:"adapter", features:["📅 自动排周","🔆 高亮本周","📊 周次概览","💾 记住设置"]},
    {id:"turntable", slug:"turntable", name:"转盘抽选", icon:"🎡", desc:"转盘形式随机抽选，动画展示直观有趣",tags:["转盘抽选","随机抽取"], mount:"adapter", features:["🎡 转盘动画","🎨 多色分区","✏️ 自定义选项","🏆 随机结果"]},
    {id:"random-question", slug:"random-question", name:"随机抽题", icon:"🎯", desc:"批量导入题目，滚动动画随机抽取，支持答案",tags:["随机抽题","批量导入"], mount:"adapter", features:["🎲 滚动动画","❓ 题目+答案","📋 批量导入","⚡ 快速抽取"]},
    {id:"chouti-2", slug:"chouti-2", name:"大屏滚动抽题", icon:"🎲", desc:"超大数字滚动动画抽号，揭晓题目与答案",tags:["大屏抽题","滚动抽号","答案揭晓"], mount:"adapter", features:["📺 大屏设计","🔢 滚动抽号","💡 揭晓答案","🖥️ 全屏"]},
    {id:"chouti-3", slug:"chouti-3", name:"滚动抽题(无答案)", icon:"🎲", desc:"无答案版滚动抽题，直接展示标题内容",tags:["大屏抽题","滚动抽号"], mount:"adapter", features:["📺 大屏设计","🔢 滚动抽号","📝 仅标题","🖥️ 全屏"]},
    {id:"chouti-4", slug:"chouti-4", name:"滚动抽题(多题)", icon:"🎲", desc:"一次随机抽取多道题，不重复",tags:["大屏抽题","多题抽取","不重复"], mount:"adapter", features:["📺 大屏设计","🔢 一次多题","🚫 不重复","🖥️ 全屏"]},
    {id:"scoreboard", slug:"scoreboard", name:"积分板", icon:"🏆", desc:"队伍加分扣分，实时排行榜，前三名高亮",tags:["积分板","排行榜","加分扣分"], mount:true, features:["➕ 加分","➖ 扣分","📊 自动排序","🥇 前三名"]},
    {id:"quick-answer", slug:"quick-answer", name:"在线抢答", icon:"🚨", desc:"点击或数字键抢答，记录抢答顺序",tags:["抢答","键盘操作"], mount:"adapter", features:["⌨️ 键盘抢答","🚨 动画反馈","📋 抢答记录","♻️ 重置"]},
    {id:"recitation-screen", slug:"recitation-screen", name:"背诵记录大屏", icon:"📖", desc:"导入学号姓名，点击切换已背诵状态，投屏展示",tags:["背诵记录","CSV导入","投屏"], mount:"adapter", features:["📥 CSV导入","✅ 状态切换","📊 大屏展示","📤 导出记录"]},
    {id:"exam-seat", slug:"exam-seat-generator", name:"考试座位安排", icon:"🪑", desc:"导入考生名单，随机排座，支持打印",tags:["考试排座","随机排座","打印"], mount:"adapter", features:["📥 CSV导入","🎲 随机排座","🖨️ 打印","🔢 自定义列数"]},
    {id:"noise-meter", slug:"noise-meter", name:"噪音计", icon:"🔊", desc:"实时检测课堂音量，超出阈值自动提醒",tags:["噪音检测","分贝","阈值提醒"], mount:"adapter", features:["🎤 麦克风检测","📊 实时分贝","⚠️ 阈值提醒","🔴 超阈值动画"]},
    {id:"quiet-meter", slug:"quiet-meter", name:"安静值", icon:"🤫", desc:"实时监测课堂安静程度，可视化反馈",tags:["安静值","音量检测"], mount:"adapter", features:["🎤 实时检测","⭕ 圆环可视化","🔢 安静值评分","🟢 状态提示"]},
    {id:"morning-reading-meter", slug:"morning-reading-meter", name:"早读检测", icon:"📢", desc:"检测早读声音强度，波形可视化鼓励朗读",tags:["早读检测","音量波形"], mount:"adapter", features:["🎤 实时检测","📊 波形动画","🔢 强度评分","📢 鼓励朗读"]},
    {id:"99table", slug:"99table", name:"九九乘法表", icon:"✖️", desc:"九九乘法口诀表，支持完整/三角布局与打印",tags:["乘法表","口诀","打印"], mount:"adapter", features:["🔢 9×9口诀","📐 完整/三角","📏 字号调节","🖨️ 打印"]},
    {id:"common-2500-hanzi", slug:"common-2500-hanzi", name:"常用2500汉字表", icon:"📚", desc:"常用汉字查询学习，支持搜索与拼音展示",tags:["汉字表","拼音","常用字"], mount:"adapter", features:["🔍 搜索汉字","🔤 拼音标注","📋 复制","📚 常用字表"]},
    {id:"primary-grade-hanzi", slug:"primary-grade-hanzi", name:"小学生字表", icon:"📖", desc:"小学各年级生字表，按年级切换查看",tags:["生字表","小学语文"], mount:"adapter", features:["🎓 1-6年级","📖 生字展示","🔢 字数统计","🖱️ 点击查看"]},
    {id:"pinyin-worksheet", slug:"pinyin-worksheet", name:"看拼音写词语", icon:"📝", desc:"输入词语生成拼音填空练习，可打印",tags:["看拼音写词语","拼音填空","打印"], mount:"adapter", features:["🔤 自动注音","🙈 隐藏汉字","📐 自定义列数","🖨️ 打印练习"]},
    {id:"stroke-order", slug:"stroke-order", name:"生字田字格练习", icon:"✏️", desc:"生成田字格练字纸，支持示范字与练习次数",tags:["田字格","练字","打印"], mount:"adapter", features:["✏️ 田字格","👀 示范字","🔢 练习次数","🖨️ 打印"]},
    {id:"xingmingtie", slug:"xingmingtie", name:"学生姓名贴", icon:"🏷️", desc:"批量生成可打印姓名贴纸，自定义样式",tags:["姓名贴","批量生成","打印"], mount:"adapter", features:["👥 批量生成","🎨 自定义颜色","📏 字号调节","🖨️ 打印"]},
    {id:"teacher-calendar", slug:"teacher-calendar", name:"教师工作日历", icon:"📅", desc:"按周展示每日日期，高亮本周，支持打印",tags:["工作日历","周历","打印"], mount:"adapter", features:["📅 按周日历","🔆 高亮本周","📆 每日日期","🖨️ 打印"]},
    {id:"paper-convert", slug:"paper-convert", name:"试卷格式转换", icon:"📐", desc:"Word 试卷 A3 与 A4 一键互转，自动调整分栏与页边距",tags:["试卷转换","A3⇄A4","分栏"], mount:"adapter", features:["📐 A3⇄A4","📑 分栏自适应","📦 批量转换","🔒 本地处理"]},
    {id:"excel-merge", slug:"excel-merge", name:"表格数据处理", icon:"📊", desc:"多张不同字段的 Excel 合为一张，自由选择字段后导出",tags:["Excel合并","数据处理","XLSX导出"], mount:"adapter", features:["📊 多表合并","🧩 按列名智能匹配","✏️ 自定义字段","⬇️ 导出 XLSX"]},
    {id:"pdf-image-convert", slug:"pdf-image-convert", name:"PDF与图片转换", icon:"📄", desc:"PDF 转 JPG/PNG 图片、多张图片合成为 PDF，双向互转",tags:["PDF转图片","图片转PDF"], mount:"adapter", features:["📄 PDF→图片","🖼️ 图片→PDF","🔍 1-3 倍清晰度","📦 多页打包"]},
    {id:"word-extract", slug:"word-extract", name:"生词提取", icon:"📝", desc:"从 Word 生词表提取词语，保留单元与园地结构，导出 Excel",tags:["生词提取","Word读取","Excel导出"], mount:"adapter", features:["📥 读取 Word","🗂️ 单元/园地分组","🔤 可选拼音列","⬇️ 导出 Excel"]},
    {id:"kinder-comment", slug:"kinder-comment", name:"幼儿园评语生成", icon:"🌈", desc:"在园表现、生活能力等 10 维度，批量生成暖心幼儿评语",tags:["评语生成","幼儿园","Word导出"], mount:"adapter", features:["🌈 10 类维度","👶 童化语气","📋 批量生成","📤 Word/Excel 导出"]},
    {id:"primary-comment", slug:"primary-comment", name:"小学评语生成", icon:"🌱", desc:"品德、学习、阅读、劳动等维度，批量生成小学期末评语",tags:["评语生成","小学","Word导出"], mount:"adapter", features:["🌱 10 类维度","📚 小学定制","📋 批量生成","📤 Word/Excel 导出"]},
    {id:"junior-comment", slug:"junior-comment", name:"初中评语生成", icon:"📘", desc:"学科表现、思维方法、集体责任等维度，批量生成初中评语",tags:["评语生成","初中","Word导出"], mount:"adapter", features:["📘 10 类维度","🎯 初中定制","📋 批量生成","📤 Word/Excel 导出"]},
    {id:"senior-comment", slug:"senior-comment", name:"高中评语生成", icon:"🎓", desc:"学习品质、思维深度、生涯规划等维度，批量生成高中评语",tags:["评语生成","高中","Word导出"], mount:"adapter", features:["🎓 10 类维度","🚀 高中定制","📋 批量生成","📤 Word/Excel 导出"]},
    {id:"formula-editor", slug:"formula-editor", name:"LaTeX公式编辑器", icon:"🧮", desc:"可视化编辑数理化复杂公式，实时渲染，导出图片或代码",tags:["LaTeX","公式编辑","PNG导出"], mount:"adapter", features:["🧮 实时渲染","🔣 符号面板","📚 内置示例","⬇️ PNG 导出"]},
    {id:"function-graph", slug:"function-graph", name:"函数绘图", icon:"📈", desc:"绘制各类函数图像，支持多函数叠加、缩放平移与导出",tags:["函数图像","绘图","PNG导出"], mount:"adapter", features:["📈 多函数叠加","🔍 缩放平移","🧮 三角/指数/对数","⬇️ PNG 导出"]},
    {id:"formula-preview", slug:"formula-preview", name:"公式预览", icon:"🧪", desc:"30 个数理化公式模板，填参数实时计算并联动函数图像",tags:["公式模板","实时计算","函数图像"], mount:"adapter", features:["🧪 30 个模板","#️⃣ 参数实时计算","📈 联动图像","📋 复制公式"]},
    {id:"countdown-timer", slug:"countdown-timer", name:"极简倒计时", icon:"⏳", desc:"深色大屏倒计时，常用时长预设，最后 10 秒声音提醒",tags:["倒计时","大屏","提示音"], mount:"adapter", features:["⏳ 极简大屏","⚡ 10 档预设","🔔 结尾提示音","🖥️ 全屏模式"]},
    {id:"shuiyin", slug:"shuiyin", name:"水印添加工具", icon:"📷", desc:"添加水印到图片，支持自定义文字、位置、透明度等",tags:["图片水印","自定义水印"], mount:"adapter", features:["水印文字","水印位置","水印透明度","水印旋转角度"]},
    {id:"zhoushiji", slug:"zhoushiji", name:"周食记", icon:"🥘", desc:"生成一周周食谱",tags:["周食谱","随机生成"], mount:"adapter", features:["周食谱","随机生成","自定义菜单"]},
    {id:"tupianqiege", slug:"tupianqiege", name:"图片分割工具", icon:"🖼️", desc:"将图片分割成多个小图，支持自定义分割大小",tags:["图片分割","批量切图"], mount:"adapter", features:["图片分割","自定义分割大小"]},
    {id:"excel-bijiao", slug:"excel-bijiao", name:"Excel 表格对比工具", icon:"📊", desc:"对比两张 Excel 表格，发现差异",tags:["Excel对比","差异比对"], mount:"adapter", features:["对比两张 Excel","发现差异"]},
    {id:"photo-collage-tool", slug:"photo-collage-tool", name:"照片拼贴工具", icon:"🖼️", desc:"将多张照片拼贴成一张大图",tags:["照片拼贴","拼图"], mount:"adapter", features:["照片拼贴","自定义拼贴"]},
    {id:"sudoku-pdf-batch", slug:"sudoku-pdf-batch", name:"数独 PDF 批量生成", icon:"🔢", desc:"批量生成数独 PDF 文件，支持自定义数独大小与难度",tags:["数独","PDF批量生成"], mount:"adapter", features:["数独生成","自定义数独大小","自定义数独难度","批量生成数独"]},
    {id:"100neijiajian", slug:"100neijiajian", name:"100内加减法", icon:"📅", desc:"生成100内加减法",tags:["加减法","口算练习","打印"], mount:"adapter", features:["100内加减法"]},
    {id:"junhengfenban", slug:"junhengfenban", name:"均衡分班工具", icon:"🔀", desc:"均衡分班，支持自定义班级人数",tags:["均衡分班","随机分班"], mount:"adapter", features:["均衡分班","自定义班级人数"]},  
    {id:"kechengbiao2", slug:"kechengbiao2", name:"课程表生成器", icon:"📅", desc:"生成我的课程表",tags:["课程表","课表生成"], mount:"adapter", features:["课程表"]},
    {id:"score-dashboard", slug:"score-dashboard", name:"成绩看板", icon:"📊", desc:"展示我的成绩，支持自定义成绩项",tags:["成绩看板","成绩展示"], mount:"adapter", features:["成绩看板","自定义成绩项"]},
    {id:"kousuan", slug:"kousuan", name:"口算练习", icon:"🔢", desc:"生成口算练习，支持自定义练习项",tags:["口算练习","打印"], mount:"adapter", features:["口算练习","自定义练习项"]},
    {id:"award-generator", slug:"award-generator", name:"电子奖状生成器", icon:"🏆", desc:"选择模板、填写获奖信息，一键生成可导出的电子奖状",tags:["电子奖状","模板生成","PNG导出"], mount:"adapter", features:["🏅 多款奖状模板","✏️ 姓名/奖项自定义","🎨 六色主题","🖨️ 打印/PNG 导出"]},
    {id:"dictation-chinese", slug:"dictation-chinese", name:"语文听写报词助手", icon:"🔉", desc:"语音报词听写，支持年级词库、重复遍数、语速与分组",tags:["听写报词","语音朗读","年级词库"], mount:"adapter", features:["🔊 语音报词","📚 1-6 年级词库","🔁 重复遍数","⏱️ 语速/间隔控制"]},
    {id:"dictation-english", slug:"dictation-english", name:"英语单词听写/拼写", icon:"🔤", desc:"英语听音默写与看词拼写双模式，实时判对错并统计",tags:["英语听写","拼写","单词练习"], mount:"adapter", features:["👂 听音默写","✍️ 看词拼写","✅ 实时判分","📊 完成统计"]},
    {id:"mental-math", slug:"mental-math", name:"口算竞技场", icon:"⚡", desc:"限时口算闯关，单人练习或小组对战，实时计分排名",tags:["口算竞技","限时闯关","小组对战"], mount:"adapter", features:["⚡ 限时挑战","🏆 单人/小组模式","🎚️ 5 档难度","📊 实时排名"]},
    {id:"grade-analyzer", slug:"grade-analyzer", name:"成绩统计分析", icon:"📊", desc:"录入成绩一键统计平均分、优秀率、及格率与分数段分布",tags:["成绩统计","成绩分析","打印"], mount:"adapter", features:["📈 均值/中位数/极差","🏅 优秀率/及格率","📊 分数段分布","🖨️ 打印报告"]},
    {id:"group-roles", slug:"group-roles", name:"组内角色分配", icon:"🎭", desc:"一键分配或逐个抽取组长、记录员等组内角色，随机不重复",tags:["角色分配","随机抽取","小组合作"], mount:"adapter", features:["🔀 一键全分配","🎲 逐个抽取","🧰 多套角色预设","📋 复制结果"]},
    {id:"xiaoxueshuxue", slug:"xiaoxueshuxue", name:"小学数学出题", icon:"🔢", desc:"生成小学数学出题，支持自定义题目类型、难度与数量",tags:["小学数学","出题","打印"], mount:"adapter", features:["小学数学出题","自定义题目类型","自定义难度","自定义数量"]},
    {id:"shuxuechuti", slug:"shuxuechuti", name:"数学出题", icon:"🔢", desc:"🎓 小学数学计算题生成器，1-6年级全覆盖 · 贴合课标 · 题型丰富 · 一键打印",tags:["数学","出题","打印"], mount:"adapter", features:["数学出题","自定义题目类型","自定义难度","自定义数量"]},
    {id:"math-mastery", slug:"math-mastery", name:"融会贯通·数学教练", icon:"∑", desc:"中小学数学技巧教练：分年级学习路径、自由练习、薄弱点复习与 AI 知识诊断（开源适配）",tags:["数学学习","学习路径","薄弱点","开源适配"], mount:"adapter", features:["📚 小学/初中/高中","🎯 分层练习","🔁 薄弱点复习","🤖 AI 知识诊断"]},
    {id:"stroke-anim", slug:"stroke-anim", name:"汉字笔顺动画", icon:"✍️", desc:"逐笔动画演示汉字笔顺，支持描红底字、笔尖指示、田字格/米字格与速度调节",tags:["笔顺","汉字","书写教学"], mount:"adapter", features:["🖌️ 逐笔动画","🧩 笔画拆分","⬜ 田字格/米字格","🐢 三档速度"]},
    {id:"flash-cards", slug:"flash-cards", name:"单词闪卡记忆", icon:"🧠", desc:"基于艾宾浩斯间隔重复的单词闪卡，支持自定义词库、英→中/中→英与掌握度反馈",tags:["闪卡","间隔重复","背单词"], mount:"adapter", features:["🔁 艾宾浩斯复习","🃏 正反面翻转","📚 四类预设词库","🔊 真人发音"]},
    {id:"random-number", slug:"random-number", name:"随机数生成器", icon:"📈", desc:"指定范围与个数生成随机数，支持不重复、排序、小数位与频率分布直方图",tags:["随机数","抽奖","概率演示"], mount:"adapter", features:["🎲 不重复抽样","📊 频率直方图","🔢 小数位控制","🕘 生成历史"]},
    {id:"duty-roster", slug:"duty-roster", name:"值日安排表", icon:"📅", desc:"按天或按周轮流排值日，自动跳过周末并支持一岗多人，可复制或打印",tags:["值日表","轮流排班","班级管理"], mount:"adapter", features:["🔁 自动轮转","📆 按天/按周","🚫 跳过周末","🖨️ 打印/复制"]},
    {id:"poem-checkin", slug:"poem-checkin", name:"古诗文背诵打卡", icon:"📚", desc:"古诗文背诵打卡与随机抽背，附连续天数、热力日历与篇目次数统计",tags:["古诗文","背诵打卡","随机抽背"], mount:"adapter", features:["✅ 一键打卡","🎯 随机抽背","🔥 连续天数","📅 打卡热力图"]},
    {id:"sci-calculator", slug:"sci-calculator", name:"科学计算器", icon:"🧮", desc:"课堂投屏大字号科学计算器：三角函数、对数、幂与根号，支持角度制/弧度制与历史记录",tags:["科学计算器","函数运算","投屏"], mount:"adapter", features:["📐 三角/对数/幂","🎚️ DEG/RAD 切换","🧠 ANS 上一结果","⌨️ 键盘直输"]},
    {id:"color-picker", slug:"color-picker", name:"课件取色器", icon:"🎨", desc:"HEX/RGB/HSL 互转、屏幕吸管与图片取色，自动生成配色方案并做 WCAG 对比度检查",tags:["取色","配色","对比度"], mount:"adapter", features:["💧 屏幕吸管","🖼 图片取色","🌈 互补/类似/三角配色","⚖️ 对比度检查"]},
    {id:"class-vote", slug:"class-vote", name:"课堂即时投票", icon:"🗳️", desc:"自定义题目与选项的随堂投票，单选/多选、参与口令、实时条形图与 CSV 导出",tags:["课堂投票","实时统计","互动"], mount:"adapter", features:["🗳️ 单选/多选","🔑 参与口令","📊 实时条形图","📥 CSV 导出"]},
    {id:"table-convert", slug:"table-convert", name:"文本表格互转", icon:"🔗", desc:"Excel/CSV/TSV 文本与 Markdown、HTML 表格互转，自动识别分隔符，支持表头、对齐、预览与下载",tags:["表格转换","Markdown","CSV"], mount:"adapter", features:["🪄 分隔符自动识别","📝 Markdown/HTML/CSV","↔️ 对齐方式可调","👀 实时预览"]},
    {id:"paper-grid", slug:"paper-grid", name:"备课本/方格纸生成", icon:"🖨️", desc:"在线生成可直接打印的稿纸：横线本、方格本、田字格、米字格、作文格，支持 A4/A5/B5 与页眉页脚",tags:["稿纸","打印","练字"], mount:"adapter", features:["📏 五种版式","📄 A4/A5/B5 纸张","✏️ 行高格宽可调","🖨️ 打印/下载 SVG"]},
    {id:"mistake-book", slug:"mistake-book", name:"课堂错题本整理", icon:"📋", desc:"录入错题、归类错因与掌握状态，支持搜索筛选、错因分布统计、打印成册与 CSV 导出",tags:["错题本","错因分析","复习"], mount:"adapter", features:["🗂️ 科目/错因归类","🔁 三档掌握状态","📊 错因分布统计","🖨️ 打印/CSV 导出"]},
    {id:"quick-ref", slug:"quick-ref", name:"学科常识速查表", icon:"🌏", desc:"单位换算、数学公式、物理常数、化学化合价、语文常识、英语不规则动词六大类速查，关键词检索与一键复制",tags:["速查表","知识点","备课"], mount:"adapter", features:["🔍 中英文关键词检索","📚 六大类 250+ 条目","📋 单条/整节/整类复制","📥 TXT 导出"]},
  ],
...
DB.categories.forEach(cat => {
  // 容错：仅有 subCategories 的分类（如 media）顶层 tools 可能为 undefined
  cat.tools = Array.isArray(cat.tools) ? cat.tools : [];
  ...
  // 子分类工具同样补 slug + catId/catName/catIcon/subCat* 字段
  if (Array.isArray(cat.subCategories)) {
    cat.subCategories.forEach(sc => {
      sc.tools = Array.isArray(sc.tools) ? sc.tools : [];
      sc.tools.forEach((t, i) => {
        t.slug = `${cat.id}-${sc.id}-${i + 1}`;
        t.catId = cat.id;
        t.catName = cat.name;
        t.catIcon = cat.icon;
        t.subCatId = sc.id;
        t.subCatName = sc.name;
        t.subCatIcon = sc.icon;
      });
    });
  }
});
